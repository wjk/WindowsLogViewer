...
public class Arc : System.Windows.Shapes.Shape
{
    ...
    /// <summary>
    /// Gets a value indicating whether if a large arc sweep should be drawn.
    /// </summary>
    /// <value>
    /// If IsLargeArc is <see langword="true"/>, then one of the two larger arc sweeps is chosen;
    /// otherwise, if is <see langword="false"/>, one of the smaller arc sweeps is chosen.
    /// </value>
    ...
    /// <para><see href="https://stackoverflow.com/a/36756365/13224348">Based on Mark Feldman's implementation</see>.</para>
    /// </summary>
    /// <returns>
    /// A <see cref="Geometry"/> instance.
    /// </returns>
    ...
    /// </summary>
    /// <param name="d">
    /// The <see cref="DependencyObject"/> that was changed.
    /// </param>
    /// <param name="e">
    /// A <see cref="DependencyPropertyChangedEventArgs"/> instance describing the change.
    /// </param>
